...
#if BAR_PANGO_PATCH
static const char font[]                 = "Source Code Pro:size=16:type=Regular:antialias=true:autohint:true"; 
#else
static const char *fonts[]               = { "Source Code Pro:size=16:type=Regular:antialias=true:autohint:true" ,
